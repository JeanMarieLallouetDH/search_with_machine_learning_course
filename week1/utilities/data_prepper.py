...
class DataPrepper:
    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id"):
        ...
        # IMPLEMENT_START --
        print("IMPLEMENTED: __log_ltr_query_features: Extract log features out of the LTR:EXT response and place in a data frame")
        ...
        for hit in response['hits']['hits']:
            docs_in_logs_response[hit['_id']] = hit['fields']['_ltrlog']
